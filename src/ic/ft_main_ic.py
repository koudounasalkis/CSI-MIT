...
def parse_cmd_line_params():
    ...
    parser.add_argument(
        ...
        help="approach to be used for bias mitigation: \
            one of 'csi', 'cm', 'knn', 'random', 'clustering', 'supervised-oracle', 'metadata-oracle",
        default="csi",
        type=str,
        required=False)
    parser.add_argument(
...
def read_data(df_folder, dataset, balancing, k=2, num_samples=161, approach='csi', verbose=False):
    if balancing:
...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        ...
        max_duration = 10.0 # 10.0 for ITALIC, 4.0 for FSC
